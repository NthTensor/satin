...
#[bench]
/// Compute the Factorial using satin::par_iter.
...
#[bench]
/// Compute the Factorial using satin::fold_with.
...
#[bench]
/// Compute the Factorial using satin::fold_chunks_with.
...
fn factorial_join(b: &mut test::Bencher) {
    fn product(a: u32, b: u32) -> BigUint {
        ...
        let mid = (a + b) / 2;
        let (x, y) = forte::join(|_| product(a, mid), |_| product(mid + 1, b));
        x * y
    }
